...
# # extend(<listaext>): vai agregar <listaext> a outra lista (somar as duas listas também faz o mesmo)
...
lista = ['python','comida','domidas', 'ab','ac', 'a', 'jaca'] #a, ab, ac, jaca, python, comida, domidas >> ['domidas', 'python', 'comida', 'jaca', 'ab', 'ac', 'a']
print(lista)
